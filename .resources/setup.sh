...
#script for  settting up termux
 ...
 pkg i  pv 
 ( pkg i root-repo openssh subversion micro git curl zsh tsu wget openssl neofetch python -y &&  echo "installing yt-dlp" && python3 -m pip install yt-dlp ) | pv -l > /dev/null
